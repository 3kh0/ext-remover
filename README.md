...
```
2. Look for your filter extension on the list. If it isn't there, toggle on developer mode and follow [this tutorial](https://extprint3r.github.io/custom/).
...
5. Enjoy! If the extension switches back on, increase the iframe slider in settings.
