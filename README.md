...
- [EXT-REMOVER](#ext-remover)
  ...
  * [Crimson/Corkey *Corrupt extensions*](#corkey-corrupt-extensions)
...
## Crimson (a.k.a. Corkey) *Corrupt extensions*

Crimson does indeed include power washing the Chromebook, which wipes local data including everything under "My files," so I suggest you select everything you want to drag and back up to Google Drive if that's available for your account.
