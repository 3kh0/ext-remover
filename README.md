...
- [EXT-REMOVER](#ext-remover)
  ...
  * [VPSE *view page sources*](#vpse--view-page-sources-)
    + [How to do](#how-to-do)
...
## VPSE *view page sources*
VPSE (view page source exploit) is an exploit that allows you to view any pages source code without any blocks ex: Ctrl+U

### How to do
add view-source: before the https:// MAKE SURE THE COLON IS THERE

you do need a functioning brain to do this
